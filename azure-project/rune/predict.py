...
MODEL_DIR = os.path.join(os.path.dirname(__file__), ".")  # Model in current directory
...
def predict_image_from_url(image_url):
    ...
    image_req = Request(url = image_url, headers=headers)
    with urlopen(image_req) as theImage:
        image = Image.open(theImage)
